...
* Security: Reality.
* uTLS: chrome.
* Dest (Target): укажите заблокированный сайт, доступный в РФ. Например `whatsapp.com:443`.
...
Дополнительно можно сменить сайт, под который будет маскироваться трафик при использовании этого протокола. Переходим в раздел OpenVPN over Cloak → Cloak → вводим в поле "Замаскировать трафик под" желаемый домен (зарубежный, и, естественно, доступный в РФ).  
